...
<div class="flex items-center gap-6 mb-8">
    ...
    <div>
        <p class="text-3xl font-bold text-text-bright">Kesler Lee</p>
        <p>CS @ ASU<br/>Incoming SWE Intern @ Expedia Group<br/>Software & ML Engineer</p>
        <div class="flex gap-4 mt-4">
            <a href="mailto:kesler@keslerlee.com" class="!text-neutral-300 hover:!text-accent-blue no-underline hover:no-underline">
            ...
            <a href="https://www.linkedin.com/in/keslerlee" target="_blank" rel="noopener noreferrer" class="!text-neutral-300 hover:!text-accent-blue no-underline hover:no-underline">
            ...
            <a href="https://github.com/keslerlee" target="_blank" rel="noopener noreferrer" class="!text-neutral-300 hover:!text-accent-blue no-underline hover:no-underline">
            ...
            <!--
            <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" class="!text-neutral-200 hover:!text-accent-blue no-underline hover:no-underline">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
            </a>
            -->
        </div>
    </div>
